...
{% set canti = load_json('data/suggeriti-top20-20260621.json') %}

## <span id="canti-suggeriti" class="text-primary-700 font-bold"> :material-music-note-plus: Canti suggeriti per Domenica 21 giugno 2026</span>

??? quote "Leggi la liturgia"

    {% include-markdown "../../risorse/lezionari/liturgie/formatted/C47-A.md" %}

    ---

    [Apri la liturgia della CEI :material-arrow-right:](https://www.chiesacattolica.it/liturgia-del-giorno/?data-liturgia=20260621){ .md-button }
...
{% set canti_esclusi = load_json('data/not-selected-20260621.json') %}
