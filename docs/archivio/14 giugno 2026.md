...
{% set canti = load_json('data/suggeriti-top20-20260614.json') %}

## <span id="canti-suggeriti" class="text-primary-700 font-bold"> :material-music-note-plus: Canti suggeriti per Domenica 14 giugno 2026</span>

??? quote "Leggi la liturgia"

    {% include-markdown "../../risorse/lezionari/liturgie/formatted/C46-A.md" %}

    ---

    [Apri la liturgia della CEI :material-arrow-right:](https://www.chiesacattolica.it/liturgia-del-giorno/?data-liturgia=20260614){ .md-button }
...
{% set canti_esclusi = load_json('data/not-selected-20260614.json') %}
